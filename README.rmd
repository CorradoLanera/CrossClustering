...
[![Travis Build Status](https://travis-ci.org/CorradoLanera/CrossClustering_svg?branch=develop)](https://travis-ci.org/CorradoLanera/CrossClustering)
...
<!-- [![CRAN Status Badge](http://www.r-pkg.org/badges/version/CrossClustering)](http://cran.R-project.org/package=CrossClustering) -->
[![Coverage Status](https://codecov.io/gh/CorradoLanera/CrossClustering/branch/develop/graph/badge_svg)](https://codecov.io/gh/CorradoLanera/CrossClustering?branch=develop)
